...
mes = ''
mes = secret_message[0][3] # 0 ознчает номер в списке, 3 означает букву в этом списке (с учетем 0)
print(mes)
mes = secret_message[1][9:13]
print(mes)
mes = secret_message[2][5:15:2]
# :2 означает через одну
print(mes)
mes = secret_message[3][12:6:-1]
# -1 разворачивает эти символы подобно reverse
print(mes)
